...
public class ActionSubProcessMap {

    private static final File mapFile = new File(Activator.getPreferencesFolder() + File.separator + "actionsubprocess-map.properties");
