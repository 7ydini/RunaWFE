...
public class ActionSubProcessVariableDialog extends Dialog {
    private final List<String> processVariables;
    private final List<String> actionsubprocessVariables;
    private String processVariable = "variable";
    private String actionsubprocessVariable = "variable";
    private final List<String> usages = Lists.newArrayList();
    private final VariableMapping oldMapping;

    protected ActionSubProcessVariableDialog(List<String> processVariables, List<String> actionsubprocessVariables, VariableMapping oldMapping) {
        super(Display.getCurrent().getActiveShell());
        this.processVariables = processVariables;
        this.actionsubprocessVariables = actionsubprocessVariables;
        this.oldMapping = oldMapping;
        if (oldMapping != null) {
            this.processVariable = oldMapping.getName();
            this.actionsubprocessVariable = oldMapping.getMappedName();
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        labelSubprocessVariable.setText(Localization.getString("ActionSubProcess.ActionSubProcessVariableName") + ":");
        ...
        varName2.setText(getActionSubProcessVariable());
        ...
        selectButton2.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                String result = new ChooseVariableNameDialog(actionsubprocessVariables).openDialog();
                if (result != null) {
                	actionsubprocessVariable = result;
                    varName2.setText(actionsubprocessVariable);
                }
            }
        });
    ...
    public String getActionSubProcessVariable() {
        return actionsubprocessVariable;
    }
}
