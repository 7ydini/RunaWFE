...
public class ProcessDefinition extends NamedGraphElement implements Describable {
    ...
    private final Map<String, ActionSubProcessDefinition> embeddedActionSubProcesses = Maps.newHashMap();
    ...
    //ActionSubProcess
    public void addEmbeddedActionSubProcess(ActionSubProcessDefinition ActionSubProcessDefinition) {
        embeddedActionSubProcesses.put(ActionSubProcessDefinition.getId(), ActionSubProcessDefinition);
    }
    //end
  ...
  //ActionSubProcess
    public ActionSubProcessDefinition getEmbeddedActionSubProcessByName(String name) {
        for (ActionSubProcessDefinition actionsubprocessDefinition : embeddedActionSubProcesses.values()) {
            if (Objects.equal(actionsubprocessDefinition.getName(), name)) {
                return actionsubprocessDefinition;
            }
        }
        return null;
    }
  ...
  //ActionProcess
    public Map<String, ActionSubProcessDefinition> getEmbeddedActionSubProcesses() {
        return embeddedActionSubProcesses;
    }

    public ActionSubProcessDefinition getEmbeddedActionSubProcessById(String id) {
        return embeddedActionSubProcesses.get(id);
    }
    //End
