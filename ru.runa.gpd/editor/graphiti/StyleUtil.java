...
public class StyleUtil implements PrefConstants {
    ...
    public static Style getActionSubProcessNodeTransactionalStyle(Diagram diagram, ActionSubProcess actionsubprocess) {
        String bpmnName = actionsubprocess.getParent().getTypeDefinition().getBpmnElementName();
        return findOrCreateStyle(diagram, bpmnName + "Transactional", new SubprocessNodeTransactionalStyleInitializer(bpmnName));
    }
