...
import ru.runa.gpd.editor.graphiti.layout.LayoutActionSubProcessNodeFeature;
import ru.runa.gpd.lang.model.ActionSubProcess;

public class UpdateActionSubProcessNodeFeature extends UpdateStateNodeFeature {

    @Override
    public IReason updateNeeded(IUpdateContext context) {
        PictogramElement pe = context.getPictogramElement();
        ActionSubProcess bo = (ActionSubProcess) getBusinessObjectForPictogramElement(pe);
    ...
    public boolean update(IUpdateContext context) {
        ...
        GraphicsAlgorithm secondBorder = PropertyUtil.findGaRecursiveByName(ga, LayoutActionSubProcessNodeFeature.SECOND_BORDER_RECT);
        ...
        GraphicsAlgorithm borderRect = PropertyUtil.findGaRecursiveByName(ga, LayoutActionSubProcessNodeFeature.BORDER_RECT);
        if (bo.isEmbedded()) {
