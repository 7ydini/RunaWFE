...
public class ActionSubProcessFigure extends StateFigure<ActionSubProcess> {
    @Override
    public void init() {
        super.init();
        addLabel();
    ...
    protected void paintFigure(Graphics g, Dimension dim) {
        ...
        if (model.isMinimizedView()) {
            ...
            // paint actionSubProcess image
            g.drawLine(dim.width - 20, dim.height - 10, dim.width - 10, dim.height - 10);
            //g.drawLine(dim.width - 20, dim.height - 10, dim.width - 18, dim.height - 10);
            //g.drawLine(dim.width - 16, dim.height - 10, dim.width - 14, dim.height - 10);
            //g.drawLine(dim.width - 12, dim.height - 10, dim.width - 10, dim.height - 10);
            
            //g.drawLine(dim.width - 20, dim.height - 10, dim.width - 20, dim.height - 8);
           // g.drawLine(dim.width - 20, dim.height - 6, dim.width - 20, dim.height - 5);
